...
if (mysqli_connect_errno())
  ...
  $sql="INSERT INTO reg_form VALUES ('h','$aadhar_no','$e_name','$category','$gender','$physi_handy','$b_name','$org_type','$pan_no','$plant_address','$office_address','$mob_no','$email_id','$commence_date','$acc_no','$ifsc','$business_activity','$business_details','$no_of_emp','$investment','$attachment')";
